...
finestraSensore::finestraSensore(QWidget* parent, std::vector<Sensore *>* sensori): QDialog(parent)
{
    ...
    sensoreBox->setFixedSize(100,25);
...
QString finestraSensore::getSensore(QWidget *parent, std::vector<Sensore *>* sensori, bool *ok)
{
