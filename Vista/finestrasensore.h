...
public:
     ...
     */
    explicit finestraSensore(QWidget* parent = nullptr, std::vector<Sensore *>* sensori = nullptr);
     ...
     */
    static QString getSensore(QWidget* parent, std::vector<Sensore *>* sensori, bool* ok = nullptr);
};
